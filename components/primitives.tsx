...
/** Ícone oficial do WhatsApp (lucide não inclui ícones de marca). */
...
/** Ícones de marca (o lucide v1 removeu os ícones de redes sociais). */
...
const ctaBase =
  "inline-flex items-center justify-center gap-2 rounded-full font-semibold transition-all duration-200 px-7 py-3.5";

const ctaVariants: Record<CTAVariant, string> = {
  primary: "bg-whats text-white hover:bg-whats-dark hover:-translate-y-0.5 shadow-glow",
  outline: "border border-primary/40 text-ink hover:bg-primary/10 hover:border-primary",
